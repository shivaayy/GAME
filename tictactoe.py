...
w.wm_iconbitmap(r'C:\Users\SHIVAM YADAV\Documents\python_PROGRAM\tic_tac.ico')
...
def main():
    ...
    Button(w,font=('Times New Roman',15),text="REPLAY",width=20,command=main).grid(row=3,column=1)
    output=Text(w,font=('Times New Roman',15),fg="green",height=2,width=73,bg="black")
